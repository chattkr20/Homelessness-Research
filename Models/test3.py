...
df = pd.read_csv("Models/data copy.csv")
array = df.to_numpy()
...
# param_grid = {
# #     'learning_rate': arange(0.05, 1, 0.075),
# #     'n_estimators': arange(50, 1000, 100),
# #     'num_leaves': arange(15, 100, 30),
#     'learning_rate': [0.05],
#     'n_estimators': [200],
#     'num_leaves': [4],
# }
...
# import pickle
# model_pkl_file = "Models/Saved Models/lgbm_model.pkl"
...
pd.DataFrame(y_pred).to_csv("Models/normalized_data_results.csv")